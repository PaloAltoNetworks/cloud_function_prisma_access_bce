...
5. Go to Google Cloud Console -> Security -> Access Context Manager, for example, see below:
6. ![image](https://user-images.githubusercontent.com/52453932/128668202-5e459a51-7921-4730-9327-72a7f137d8ca.png)
   access_policy_id is: 515250846142
   access_level_id: prisma_access_address
7. Run "terraform init"
8. Run "terraform plan"
9. Check everything is acting as you expected
10. Run "terraform deploy"
11. Click the Output URL after the deployment finished, it will auto-added a random token id for authentication for the Cloud Function call
12. If the feedback is "Successful", means you have deployed the Cloud Function successfully, and tested good.
13. Copy and paste the Output URL into Palo Alto Networks Panorama for the Primsa Access IP change auto notification and automate the Google BeyondCorp access level update.
